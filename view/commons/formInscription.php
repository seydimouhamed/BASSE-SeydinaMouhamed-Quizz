<div class="div1_1">
            ...
            <div class="box_left_1">
                <div class="width_90_1">
                    ...
                    <small><?php if(isset($msg)){ echo "$msg";}else{ echo "Pour tester votre niveau de culture générale";}?> </small>
                    <hr/>
                    <form action="controller.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="div_input_1"><input class="ipbtn_1" type="submit" name="inscription" value="Créer compte">&nbsp;&nbsp;&nbsp;<a href="#"><small>Se connecter</small></a></div>
                    </form>
                </div>
            </div>
            <div class="box_right_1">
                <img class="imgProfil_1" alt='logo' id="avatar" src="public/icones/img5.jpg">
                <p class="center">Avatar du joueur </p>
            </div>
            </div>
            </div>
