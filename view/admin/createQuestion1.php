...
<div class="contain_pl">
	    ...
	    <div class="contain_sub">
		        <form method="POST" id="mainform" name="mainform" action="index.php?origin=admin" onsubmit="return validate();">
		            <div class="div_question">
		                <label>Questions</label>
                        <textarea name="question" error='error_1'></textarea>
                        <small class="error" id='error_1'></small>
		            </div>
		            <div class="div_score">
		                <label>Nbr de point </label><input type="number" error='error_2' name="score" />
